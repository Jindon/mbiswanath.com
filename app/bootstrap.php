...
// ponytail: silences PHP 8.5's PDO::MYSQL_ATTR_SSL_CA deprecation from
// vendor/laravel-zero/foundation's default db config, which this static
// site never uses. Drop once laravel-zero/framework fixes it upstream.
